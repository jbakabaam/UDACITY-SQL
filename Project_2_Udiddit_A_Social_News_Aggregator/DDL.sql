...
-- Create Index for a list of all users who haven’t logged in in the last year
...
-- Create Index for finding a user by their username
...
-- Create Indexes to list all topics that don’t have any posts
...
-- Create Index for finding a topic by its name
...
-- Create Indexes for a list all users who haven’t created any post
...
-- Create Index for a list of latest posts for a given topic
...
-- Create Index for a list of latest posts for a given user
...
-- Create Create Index to find posts with URL
...
-- Create Index for all the top-level comments for a given post
...
-- Create Index for all the direct children of a parent comment
...
-- Create Index to list the latest comments made by a given user
...
-- Create Index to find score of post
